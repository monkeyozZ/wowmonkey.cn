<template>
  <div class="share">
    ...
    <div class="share_box">
      <a href="javascript:;" @click="Share(weibo)"><i class="iconfont icon-weibo" /></a>
      <a href="javascript:;" @click="Share(weixin)"><i class="iconfont icon-weixin" /></a>
      <a href="javascript:;" @click="Share(qq)"><i class="iconfont icon-qq" /></a>
      <a href="javascript:;" @click="Share(qzone)"><i class="iconfont icon-qzone" /></a>
      <!--<a href="javascript:;" @click="Share(tencentwb)">tqq</a>-->
      <a href="javascript:;" @click="Share(renren)"><i class="iconfont icon-renren" /></a>
      <a href="javascript:;" @click="Share(douban)"><i class="iconfont icon-douban" /></a>
      <a href="javascript:;" @click="Share(facebook)"><i class="iconfont icon-facebook" /></a>
      <a href="javascript:;" @click="Share(twitter)"><i class="iconfont icon-twitter" /></a>
      <a href="javascript:;" @click="Share(linkedin)"><i class="iconfont icon-linkedin" /></a>
    </div>
  </div>
</template>
